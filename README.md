...
- **27 built-in feature modules** — Terminal, processes, Docker, disk, network, file browser, services, cron jobs, environment variables, AI agents, self-service installs, and more
