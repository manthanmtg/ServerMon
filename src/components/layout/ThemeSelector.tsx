        ...
        <div className="relative" ref={containerRef}>
            <Button
                ...
                className={cn(
                    ...
                    isOpen ? "bg-accent text-accent-foreground" : "hover:bg-accent/50 text-muted-foreground hover:text-foreground"
                )}
            >
            ...
            {isOpen && (
                <div className="absolute right-0 mt-2 w-56 p-1.5 z-50 rounded-2xl border border-white/5 bg-popover/80 backdrop-blur-xl shadow-2xl animate-in fade-in zoom-in-95 duration-200">
                    <div className="px-2.5 py-2 mb-1 border-b border-border/30">
                        <p className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/50">Interface Theme</p>
                    </div>
