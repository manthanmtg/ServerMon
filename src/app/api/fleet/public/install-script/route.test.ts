...
describe('GET /api/fleet/public/install-script', () => {
  it('keeps the route dynamic so the installer is served at request time', () => {
  ...
  it('prevents caching so new agents receive the current installer', async () => {
    const response = await GET();
