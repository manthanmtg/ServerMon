...
function getMockData(): PortsSnapshot {
    return {
        ...
        source: 'mock',
        listening: [
            { protocol: 'tcp', port: 22, address: '0.0.0.0', pid: 1234, process: 'sshd', user: 'root', state: 'LISTEN', family: 'IPv4' },
            { protocol: 'tcp', port: 80, address: '0.0.0.0', pid: 2345, process: 'nginx', user: 'www-data', state: 'LISTEN', family: 'IPv4' },
            { protocol: 'tcp', port: 443, address: '0.0.0.0', pid: 2345, process: 'nginx', user: 'www-data', state: 'LISTEN', family: 'IPv4' },
            { protocol: 'tcp', port: 3000, address: '127.0.0.1', pid: 3456, process: 'node', user: 'deploy', state: 'LISTEN', family: 'IPv4' },
            { protocol: 'tcp', port: 5432, address: '127.0.0.1', pid: 4567, process: 'postgres', user: 'postgres', state: 'LISTEN', family: 'IPv4' },
            { protocol: 'tcp', port: 6379, address: '127.0.0.1', pid: 5678, process: 'redis-server', user: 'redis', state: 'LISTEN', family: 'IPv4' },
            { protocol: 'tcp', port: 8912, address: '0.0.0.0', pid: 6789, process: 'node', user: 'deploy', state: 'LISTEN', family: 'IPv4' },
            { protocol: 'tcp', port: 27017, address: '127.0.0.1', pid: 7890, process: 'mongod', user: 'mongodb', state: 'LISTEN', family: 'IPv4' },
            { protocol: 'udp', port: 53, address: '0.0.0.0', pid: 8901, process: 'systemd-resolve', user: 'systemd-resolve', state: 'UNCONN', family: 'IPv4' },
            { protocol: 'udp', port: 68, address: '0.0.0.0', pid: 9012, process: 'dhclient', user: 'root', state: 'UNCONN', family: 'IPv4' },
        ],
        summary: {
            totalListening: 10,
            tcpCount: 8,
