...
export async function verifyToken(endpointId: string, rawToken: string): Promise<boolean> {
  await connectDB();
...
export async function verifyTokenBySlug(slug: string, rawToken: string): Promise<boolean> {
  await connectDB();
...
export async function revokeToken(endpointId: string, tokenId: string): Promise<boolean> {
  await connectDB();
