    ...
    return (
        <div className="flex flex-col h-full gap-4">
            <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-[11px] text-muted-foreground uppercase tracking-wider font-medium">RAM Status</p>
                    </div>
                </div>
            ...
            <div className="flex items-center justify-between pt-2 border-t border-border/50">
                ...
                <a href="/memory" className="text-[11px] font-bold text-primary flex items-center gap-1 hover:underline group">
                    View Specs <ArrowRight className="w-3 h-3 transition-transform group-hover:translate-x-0.5" />
                </a>
            </div>
        </div>
    );
