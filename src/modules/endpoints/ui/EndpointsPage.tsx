              ...
              >
                <span
                  className={cn(
                    ...
                    val === 'true' ? 'bg-success' : 'bg-muted-foreground/40'
                  )}
                />
      ...
      {showDetail && (
        ...
        >
          ...
          <div className="flex items-center gap-2 sm:gap-3 px-3 sm:px-5 py-3 border-b border-border/40 bg-card/60">
            <button
              onClick={closeDetail}
              className="lg:hidden p-1.5 rounded-lg hover:bg-accent text-muted-foreground shrink-0"
            >
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {(form.tags || []).map((tag, i) => (
                      <span
                        key={i}
                        className="inline-flex items-center gap-1 px-2 py-1 rounded-lg bg-muted/50 border border-border/40 text-xs"
                      >
                ...
                <div className="flex items-center justify-between py-2">
                  <div>
                    ...
                    <div className="text-[11px] text-muted-foreground">
                      Endpoint is callable when enabled
                    </div>
                  </div>
                  <button
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between py-2">
                      <div>
                        ...
                        <div className="text-[11px] text-muted-foreground">
                          Pass incoming headers to the target
                        </div>
                      </div>
                      <button
                        onClick={() =>
                        ...
                        className={cn(
                          'w-11 h-6 rounded-full transition-all relative',
                          form.webhookConfig?.forwardHeaders
                            ? 'bg-success'
                ...
                {isCreating && (
                  <div className="flex flex-col items-center py-8 text-center bg-muted/20 rounded-xl border border-dashed border-border/60">
                    ...
                    <p className="text-sm font-medium text-muted-foreground">
                      Tokens require a saved endpoint
                    </p>
                    <p className="text-[11px] text-muted-foreground/60 max-w-[240px]">
                      ...
                      available after you save the endpoint.
                    </p>
                  </div>
                )}
                  ...
                  <>
                    ...
                    {generatedToken && (
                      <div className="p-4 rounded-xl border border-warning/30 bg-warning/5">
                        ...
                        <div className="flex items-center gap-2">
                          <code className="flex-1 text-xs font-mono bg-background/50 px-3 py-2 rounded-lg break-all">
                            {generatedToken}
                          </code>
                          <button
                            onClick={async () => {
                    ...
                    {tokensLoading ? (
                      ...
                      <div className="flex flex-col items-center py-8 text-center">
                        ...
                        <p className="text-[11px] text-muted-foreground/70">
                          Generate a token to protect this endpoint
                        </p>
                      </div>
                    ) : (
                      <div className="space-y-2">
                    ...
                    <div className="mt-8 space-y-4 pt-6 border-t border-border/40">
                          ...
                          {exampleTab === 'curl' ? (
                            <>
                              ...
                              <span className="text-green-400">
                                &quot;{window.location.origin}/api/endpoints/{form.slug}&quot;
                              </span>{' '}
                              \<br />
                      ...
                      <p className="text-[10px] text-muted-foreground/60 italic">
                        Replace <code className="text-primary font-bold">YOUR_TOKEN</code> with one
                        of the generated tokens above.
                      </p>
                    </div>
                  </>
                )}
              ...
              <div className="space-y-3 animate-in fade-in duration-200">
                {logsLoading ? (
                  ...
                  <div className="flex flex-col items-center py-12 text-center">
                    ...
                    <p className="text-[11px] text-muted-foreground/70">
                      Logs will appear here after the endpoint is created and called.
                    </p>
                  </div>
                ) : logs.length === 0 ? (
                  <div className="flex flex-col items-center py-12 text-center">
                    ...
                    <p className="text-[11px] text-muted-foreground/70">
                      Logs will appear here after the endpoint is called
                    </p>
                  </div>
                ) : (
                  logs.map((entry) => <LogEntry key={entry._id} entry={entry} />)
                )}
              </div>
            )}
              ...
              <div className="space-y-6 animate-in fade-in duration-200">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      onClick={() =>
                        updateForm('responseHeaders', { ...(form.responseHeaders || {}), '': '' })
                      }
                      className="text-[10px] text-primary hover:underline"
                    >
                      + Add
                ...
                <div className="p-3 overflow-y-auto relative">
                  ...
                  {testLoading ? (
                    ...
                    <div className="space-y-2">
                      ...
                      {testResult.stderr && (
                        <div className="mt-2">
                          <p className="text-[10px] text-destructive/70 uppercase tracking-wider mb-1">
                            Stderr
                          </p>
                          <pre className="text-destructive/60 text-xs font-mono whitespace-pre-wrap">
                            {testResult.stderr}
                          </pre>
                        </div>
                      )}
              ...
              {templates.map((tmpl) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    {tmpl.scriptLang && (
                      <span className="px-1.5 py-0.5 rounded-md bg-muted/50 text-[10px] font-mono text-muted-foreground capitalize">
                        {tmpl.scriptLang}
                      </span>
                    )}
                    <span className="px-1.5 py-0.5 rounded-md bg-muted/50 text-[10px] text-muted-foreground capitalize">
                      {tmpl.endpointType}
                    </span>
                  </div>
                </button>
  ...
  return (
    <div className="rounded-xl border border-border/30 overflow-hidden">
      ...
      >
        ...
        <Badge
          variant={entry.triggeredBy === 'test' ? 'outline' : 'default'}
        ...
        <div className="px-4 py-3 border-t border-border/20 bg-muted/10 space-y-3 text-xs animate-in fade-in duration-200">
          {entry.requestBody && (
            <div>
              ...
              <pre className="font-mono text-foreground/80 bg-background/50 rounded-lg px-3 py-2 whitespace-pre-wrap break-all max-h-32 overflow-y-auto">
                {entry.requestBody}
              </pre>
            </div>
          )}
          ...
          {entry.stderr && (
            <div>
              <p className="text-[10px] font-medium text-destructive/70 uppercase tracking-wider mb-1">
                Stderr
              </p>
              <pre className="font-mono text-destructive/80 bg-destructive/5 rounded-lg px-3 py-2 whitespace-pre-wrap break-all max-h-32 overflow-y-auto">
                {entry.stderr}
              </pre>
            </div>
          )}
          ...
          <div className="flex items-center gap-4 text-[10px] text-muted-foreground/60">
            ...
            {entry.requestMeta.userAgent && (
              <span className="truncate">{entry.requestMeta.userAgent}</span>
            )}
          </div>
        </div>
      )}
