            ...
            <CardContent>
                ...
                {topEndpoints.length > 0 && (
                    <div className="mt-3 space-y-1.5">
                        <p className="text-[10px] font-medium text-muted-foreground uppercase tracking-wider">Top Endpoints</p>
                        {topEndpoints.map((ep) => (
                            <div key={ep._id} className="flex items-center gap-2 text-xs">
                                <span className={cn('font-mono font-bold text-[10px]', METHOD_COLORS[ep.method] || 'text-foreground')}>
                                    {ep.method}
                                </span>
