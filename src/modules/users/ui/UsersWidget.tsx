    ...
    return (
        <div className="flex flex-col h-full gap-4">
            <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-[11px] text-muted-foreground uppercase tracking-wider font-medium">Perms Overview</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
                <div className="p-3 rounded-xl bg-accent/30 border border-border/50">
                    ...
                    <div className="flex items-center gap-1.5 mt-0.5">
                        ...
                        <span className="text-[10px] font-medium text-muted-foreground uppercase">Web Users</span>
                    </div>
                </div>
                <div className="p-3 rounded-xl bg-accent/30 border border-border/50">
                    ...
                    <div className="flex items-center gap-1.5 mt-0.5">
                        ...
                        <span className="text-[10px] font-medium text-muted-foreground uppercase">OS Users</span>
                    </div>
                </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-2 border-t border-border/50">
                ...
                <a href="/users" className="text-[11px] font-bold text-indigo-500 flex items-center gap-1 hover:underline group">
