                          ...
                          <td className="py-3">
                            <div className="flex flex-wrap gap-2">
                              <Button
                                ...
                                variant="outline"
                                disabled={
                                  pendingActionId === container.id || container.state === 'running'
                                }
                              ...
                              <Button
                                size="sm"
                                variant="outline"
                                disabled={pendingActionId === container.id}
                              ...
                              <Button
                                ...
                                disabled={pendingActionId === container.id}
                                onClick={() => runAction(container.id, 'remove')}
                              >
                                <Trash2 className="h-4 w-4" />
                              </Button>
                              <Button
                                ...
                                onClick={() => {
                                  ...
                                  setTerminalCommand(`docker logs -f ${container.name}\n`);
                                }}
                              >
                                Logs
                              </Button>
                              <Button
                                ...
                                onClick={() => {
                                  setSelectedContainerId(container.id);
                                  setTerminalCommand(`docker exec -it ${container.name} sh\n`);
                                }}
                              >
                                Exec
                              </Button>
                              ...
                              <div className="grid gap-4 lg:grid-cols-3">
                                <div className="space-y-2">
                                  ...
                                  <div className="rounded-xl border border-border/60 bg-card p-3">
                                    ...
                                    <p>
                                      Memory usage: {formatBytes(container.memoryUsageBytes)} /{' '}
                                ...
                                <div className="space-y-2">
                                  ...
                                  <div className="max-h-48 overflow-y-auto rounded-xl border border-border/60 bg-card p-3 font-mono text-xs text-muted-foreground">
                                    {container.env.length > 0
                                      ? container.env.map((entry) => <div key={entry}>{entry}</div>)
              ...
              <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="flex flex-wrap gap-2">
                  <Button
                    size="sm"
                    variant="outline"
                    onClick={() => setTerminalCommand('docker ps -a\n')}
                  >
                    Containers
                  </Button>
                  <Button
                    size="sm"
                    variant="outline"
                    onClick={() => setTerminalCommand('docker images\n')}
                  >
                    Images
                  </Button>
                  <Button
                    size="sm"
                    variant="outline"
                    onClick={() => setTerminalCommand('docker compose ps\n')}
                  >
                    Compose
                  </Button>
                  <Button
                    size="sm"
                    variant="outline"
                    onClick={() => setTerminalCommand('crictl ps -a\n')}
                  >
                    CRI
                  </Button>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="rounded-xl border border-border/60 bg-muted/20 p-3">
                    ...
                    <p className="text-[10px] text-muted-foreground">
                      {snapshot?.diskUsage.usedPercent.toFixed(1) || '0.0'}% used
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">
                    ...
                    group. The UI remains available with mock/test data, but live actions need
                    daemon permissions.
                  </p>
                </div>
              </div>
