...
const mockNetworkSnapshot = {
  ...
  stats: [
    { iface: 'eth0', rx_sec: 1024, tx_sec: 512, rx_packets: 100, tx_packets: 50, rx_errors: 0, tx_errors: 0, rx_dropped: 0, tx_dropped: 0 },
    { iface: 'lo', rx_sec: 0, tx_sec: 0, rx_packets: 10, tx_packets: 10, rx_errors: 0, tx_errors: 0, rx_dropped: 0, tx_dropped: 0 }
  ],
  connections: [
    { protocol: 'tcp', localAddress: '0.0.0.0', localPort: 80, peerAddress: '0.0.0.0', peerPort: 0, state: 'LISTEN', process: 'nginx' },
    { protocol: 'tcp', localAddress: '192.168.1.10', localPort: 443, peerAddress: '10.0.0.5', peerPort: 54321, state: 'ESTABLISHED', process: 'nginx' }
  ],
  history: [
