  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
      {cards.map(({ label, value, icon: Icon, color }) => (
        <Card
          key={label}
          className="border-border/60 bg-card/80 hover:border-primary/20 transition-all duration-300 hover:shadow-[0_4px_12px_-4px_color-mix(in_oklab,var(--primary)_15%,transparent)] group"
        >
