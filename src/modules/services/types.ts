export type ServiceState = 'active' | 'inactive' | 'failed' | 'activating' | 'deactivating' | 'reloading' | 'unknown';
export type ServiceSubState = 'running' | 'exited' | 'dead' | 'waiting' | 'start-pre' | 'start' | 'stop' | 'stop-post' | 'failed' | 'auto-restart' | 'listening' | 'mounted' | 'plugged' | 'unknown';
