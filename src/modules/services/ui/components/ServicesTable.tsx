...
interface ServicesTableProps {
  ...
  onSort: (field: ServicesSortField) => void;
...
function SortHeader({
  ...
  return (
    <th className="py-3 px-4 cursor-pointer select-none" onClick={() => onSort(field)}>
                  ...
                  <Fragment key={svc.name}>
                    ...
                    >
                      <td className="py-3 px-4">
                        <button
                          type="button"
                          onClick={() => onExpandedServiceChange(isExpanded ? null : svc.name)}
