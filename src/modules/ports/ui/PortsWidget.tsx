            ...
            <CardContent>
                ...
                {snapshot?.firewall.available && (
                    <div className={cn(
                        ...
                        <span className={cn('font-medium', snapshot.firewall.enabled ? 'text-success' : 'text-warning')}>
                            Firewall: {snapshot.firewall.enabled ? 'Active' : 'Inactive'} ({snapshot.firewall.backend})
                        </span>
                    </div>
                )}
            </CardContent>
