...
GitHub releases can include prebuilt tarballs generated by the `Release Artifacts` workflow. The workflow runs for `v*` tags and can also be started manually with a release tag.
